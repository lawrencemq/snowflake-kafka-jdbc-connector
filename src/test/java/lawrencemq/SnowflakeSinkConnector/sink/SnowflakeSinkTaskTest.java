...
import static lawrencemq.SnowflakeSinkConnector.sink.RecordBufferTest.generateMessages;
...
class SnowflakeSinkTaskTest {
    ...
    SnowflakeSinkTask task;

    @BeforeEach
    void setupSinkTask(){
        task = new TestSnowflakeSinkTask();
    ...
    private class TestSnowflakeSinkTask extends SnowflakeSinkTask {
