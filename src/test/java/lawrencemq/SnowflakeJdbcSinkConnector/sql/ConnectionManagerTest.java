...
import static lawrencemq.SnowflakeJdbcSinkConnector.sink.SnowflakeJdbcSinkConnectorConfig.SNOWFLAKE_RETRY_BACKOFF_MS;
...
class ConnectionManagerTest {
    ...
    private static SnowflakeJdbcSinkConnectorConfig genConfig(Map<?, ?> properties) {
